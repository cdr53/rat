classdef CanvasText
    ...
    methods
        ...
        function [ns_text,tab_text] = build_text(obj)
            ...
            if (obj.model.num_neurons) == 0
                ...
                for i = 1:obj.model.num_adapters
                    adapter_holder = obj.build_adapter(obj.model.adapter_objects(i));
        ...
        %% Build Adapter
        function out_text = build_adapter(~,adapter)
        ...
        function out_text = build_stimulus(~,stimulus)
            ...
            out_text = {'<Stimulus>';...
                    ...
                    ['<CurrentOn Value="',num2str(stimulus.magnitude),'" Scale="nano" Actual="1e-008"/>'];...
...
%             end
        ...
        %% Build AFORM
        function out_text = build_aform_text(~,datatool)
            ...
            if numDTaxes > 0
                ...
                for ii = 1:numDTaxes
                    ...
                    ax_holder = {'<Axis>';...
                        ...
                        ['<Name>',dtaxes.name,'</Name>'];...
                        ['<WorkingAxis>',num2str(ii-1),'</WorkingAxis>'];...
                        '<DataColumns>';...
                        '<DataColumn>';...
                        '<AssemblyFile>LicensedAnimatGUI.dll</AssemblyFile>';...
                        '<ClassName>LicensedAnimatGUI.DataObjects.Charting.Pro2DColumn</ClassName>';...
                        ['<Name>',dtaxes.target_name,'</Name>'];...
                        ['<ID>',dtaxes.tdata_ID,'</ID>'];...
                        '<DataItemAssemblyFile>IntegrateFireGUI.dll</DataItemAssemblyFile>';...
                        '<DataItemClassName>IntegrateFireGUI.DataObjects.Behavior.Neurons.NonSpiking</DataItemClassName>';...
                        '<StructureID>e40d2c4f-9c31-49f8-8a5c-5688fb768225</StructureID>';...
                        ['<DataItemID>',dtaxes.target_ID,'</DataItemID>'];...
                        '<SelectedDataType>MembraneVoltage</SelectedDataType>';...
                        ['<DataSubSet>',num2str(ii-1),'</DataSubSet>'];...
                        ['<PrevDataSubset>',num2str(ii-1),'</PrevDataSubset>'];...
            ...
            out_text = [{'<Form>';...
                ...
                '<CollectDataInterval Value="0.2" Scale="milli" Actual="0.0002"/>';...
                ...
                '<CollectStartTime Value="0" Scale="None" Actual="0"/>';...
                '<CollectEndTime Value="10" Scale="None" Actual="10"/>'};...
                axes_insert;...
